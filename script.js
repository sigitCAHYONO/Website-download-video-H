...
// Handler untuk tombol kembali di header agar bisa kembali dari feed
// Gantikan fungsi showHomeView Anda dengan yang ini
function showHomeView() {
        homeSection.style.display = 'flex';
        mainHeader.style.display = 'none';
        groupChatSection.style.display = 'none'; 
        profileSettingsSection.style.display = 'none';
        tiktokFeedSection.style.display = 'none'; // Tambahkan ini
        groupChatInputBar.style.display = 'none'; 
        replyContextBar.style.display = 'none';
        currentView = 'home';
        if (websocket && websocket.readyState === WebSocket.OPEN) {
